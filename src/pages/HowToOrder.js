    ...
    const steps = [
        {
            ...
            description:
                "Выберите интересующую Вас группу товаров. Для Вас откроется страница, где представлены товары с указанием цены, фотографией и несколькими наиболее важными характеристиками. Выберите интересующие вас очки",
        },
        {
            number: 2,
    ...
    const tips = [
        {
            ...
            description:
                "Создайте аккаунт, чтобы получить карту лояльности и накапливать бонусы",
        },
        {
            title: "Используйте фильтры",
            description:
                "Найдите идеальные очки быстрее с помощью фильтров по бренду, цене и стилю",
        },
        {
            title: "Посетите салон",
            description:
                "Приходите примерить очки в один из наших салонов и получите профессиональную консультацию",
        },
        {
            title: "Следите за акциями",
            description:
                "Подпишитесь на рассылку, чтобы первыми узнавать о скидках и спецпредложениях",
        },
    ];
                            ...
                            >
                                ...
                                <div className="flex items-center space-x-6 lg:space-x-8 lg:w-1/4">
                                    <div className="relative">
                                        <div className="w-20 h-20 bg-gradient-to-br from-[#e31e24] to-[#c41c20] rounded-2xl text-white flex items-center justify-center text-2xl font-bold transform group-hover:scale-110 transition-transform duration-300 ">
                                            {step.number}
                                        </div>
            ...
            <section className="py-20 bg-gradient-to-br from-[#c41c20] via-[#e31e24] to-[#e31e24]/80 text-white relative overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto px-4 relative z-10 text-center">
                    ...
                    <p className="text-xl mb-8 text-white/90">
                        Наша команда всегда готова ответить на ваши вопросы и
                        помочь с заказом
                    </p>
                    ...
                    <div className="mt-12 bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20">
                        <div className="flex items-center justify-center space-x-4">
                            ...
                            <p className="text-white/90">
                                После оформления заказа наш консультант свяжется
                                с вами для подтверждения и уточнения деталей
                            </p>
                        </div>
                    </div>
                </div>
