...
import { ArrowRight, MapPin, Users, Award, ShoppingBag, Phone, Clock } from 'lucide-react';
...
const Home = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'Удобное расположение в центре города для быстрого доступа',
    },
    {
      icon: <Users size={32} />,
      title: 'Опытные специалисты',
      description: 'Профессиональная консультация и индивидуальный подбор',
    },
    {
      icon: <Award size={32} />,
      title: 'Очки и оправы на любой вкус',
      description: 'Стильные модели для повседневной носки и особых случаев',
    },
  ];
  ...
  const getLogoSizeClass = (name) => {
    ...
    return largerBrands.includes(name) ? 'w-48 h-24 object-contain' : 'w-32 h-16 object-contain';
  };
  ...
  const addresses = [
    {
      ...
      mapUrl: 'https://yandex.ru/maps/?text=Казань,%20Николая%20Ершова,%2047'
    },
    {
      address: 'г. Казань, Меридианная, 4',
      phones: ['+7 (843) 528‒07‒08'],
      schedule: 'Пн-Пт: 9.00 — 20.00 Сб: 10.00 — 19:00 Вс: выходной',
      mapUrl: 'https://yandex.ru/maps/?text=Казань,%20Меридианная,%204'
    }
  ];
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="hero-section relative overflow-hidden h-screen flex items-center justify-center bg-gradient-to-br from-blue-900 via-[#9c0101] to-[#740000]">
        {/* Фоновое изображение: люди в очках (placeholder; замените на реальное фото) */}
        <div
          className="absolute inset-0 bg-cover bg-center opacity-20"
          style={{
            backgroundImage: "url('https://images.unsplash.com/photo-1572635196237-14b3f281503f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80')", // Unsplash: люди в очках
          }}
        />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center w-full">
          <div className="text-center w-full" style={{ transform: `translateY(${scrollY * -0.15}px)` }}>
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold text-white mb-6 animate-fade-in [text-shadow:0_2px_4px_rgba(0,0,0,0.1),0_1px_0_rgba(255,255,255,0.5)]">
              Очки и оправы
              <br />
              <span className="bg-gradient-to-r from-[#9c0101] to-[#740000] bg-clip-text text-transparent">на любой вкус</span>
            </h1>
            <p className="text-xl md:text-2xl text-white mb-12 max-w-3xl mx-auto animate-fade-in-up"> {/* Полностью белый */}
              Широкий ассортимент премиальной оптики от ведущих мировых брендов
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center animate-scale-in">
              <Link
                to="/frames"
                className="btn-primary inline-flex items-center justify-center space-x-2 px-6 py-3 rounded-full font-semibold transition-all duration-300 bg-gradient-to-r from-[#9c0101] to-[#740000] shadow-[0_8px_32px_rgba(156,1,1,0.4),inset_0_1px_0_rgba(255,255,255,0.2)] border border-[#9c0101]/20 hover:shadow-[0_12px_40px_rgba(156,1,1,0.5)] hover:-translate-y-1 hover:scale-105 before:content-[''] before:absolute before:inset-0 before:rounded-full before:bg-gradient-to-t before:from-transparent before:to-white before:opacity-0 hover:before:opacity-20" /* Добавлен блеск как на конфетке */
                data-testid="frames-btn"
                style={{ position: 'relative', overflow: 'hidden' }}
              >
                <span className="relative z-10 text-white [text-shadow:0_1px_2px_rgba(0,0,0,0.3)]">Оправы</span> {/* Белый с тенью */}
              ...
              <Link
                ...
                style={{ position: 'relative', overflow: 'hidden' }}
              >
                <span className="relative z-10 text-white [text-shadow:0_1px_2px_rgba(0,0,0,0.3)]">Солнцезащитные очки</span>
                <ArrowRight size={20} className="relative z-10" />
              </Link>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              ...
              >
                <div className="inline-flex items-center justify-center w-16 h-16 rounded-full text-white mb-4 transform hover:scale-110 transition-transform duration-300 mx-auto bg-gradient-to-r from-[#9c0101] to-[#740000] shadow-[0_4px_14px_0_rgba(156,1,1,0.3)]"> {/* Красный градиент */}
                  {feature.icon}
                </div>
                <h3 className="text-xl font-bold text-[#740000] mb-2 [text-shadow:0_2px_4px_rgba(0,0,0,0.1),0_1px_0_rgba(255,255,255,0.5)]">{feature.title}</h3> {/* Темно-красный */}
      ...
      <section className="py-20 bg-gradient-to-br from-white to-blue-50">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h2 className="text-4xl md:text-5xl font-bold text-[#740000] mb-4 animate-on-scroll opacity-0 [text-shadow:0_2px_4px_rgba(0,0,0,0.1),0_1px_0_rgba(255,255,255,0.5)]"> {/* Темно-красный */}
            Логотипы брендов
          </h2>
              ...
              >
                <div className="w-full h-24 flex items-center justify-center">
                  <img
                    ...
                    onError={(e) => {
                      console.error(`Ошибка загрузки изображения для бренда: ${brand.name}`);
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-600 mb-12 animate-on-scroll opacity-0 max-w-3xl mx-auto">
            Откройте для себя полную коллекцию наших очков, оправ и линз. 
            Мы предлагаем только качественную продукцию от проверенных производителей.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {addresses.map((location, index) => (
              <div
                key={index}
                className="animate-on-scroll opacity-0 bg-white rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 border border-gray-100"
              >
                <div className="flex items-start space-x-4 mb-6">
                  ...
                  <div className="text-left">
                    <h3 className="text-xl font-bold text-[#740000] mb-2">Салон {index + 1}</h3>
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    <Phone size={20} className="text-[#9c0101] mt-1 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold text-gray-800 mb-2">Телефоны:</h4>
                      {location.phones.map((phone, phoneIndex) => (
                        <p key={phoneIndex} className="text-gray-600 hover:text-[#9c0101] transition-colors">
                          {phone}
                        </p>
                      ))}
                    </div>
                  ...
                  <div className="flex items-start space-x-3">
                    <Clock size={20} className="text-[#9c0101] mt-1 flex-shrink-0" />
                    <div>
                ...
                {/* Индивидуальная ссылка на карту для каждого салона */}
                <div className="mt-6 pt-4 border-t border-gray-200">
                  <a
                    href={location.mapUrl}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center justify-center space-x-2 px-6 py-2 rounded-xl font-semibold transition-all duration-300 bg-gradient-to-r from-[#9c0101] to-[#740000] text-white shadow-[0_4px_14px_0_rgba(156,1,1,0.3)] hover:shadow-[0_6px_20px_rgba(156,1,1,0.4)] hover:-translate-y-0.5 w-full"
                    style={{ position: 'relative', overflow: 'hidden' }}
                  >
                    <MapPin size={16} />
      ...
      <section className="py-20 relative overflow-hidden text-white bg-gradient-to-br from-[#740000] via-[#9c0101] to-blue-900"> {/* Используем указанные красные */}
        <div
          className="absolute inset-0 opacity-10 bg-[radial-gradient(circle,rgba(156,1,1,0.3)_2px,transparent_0)] bg-[length:40px_40px]"
        />
        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 animate-on-scroll opacity-0 [text-shadow:0_1px_2px_rgba(0,0,0,0.3)]"> {/* Добавлена тень */}
            Приходите к нам, чтобы примерить очки и получить профессиональную консультацию
          </p>
        </div>
      </section>
    </div>
